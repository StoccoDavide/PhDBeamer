  ...
  \begin{columns}
    \begin{column}[c]{0.2\textwidth}
      ...
      \uncover<4->{\begin{tikzpicture}[overlay, remember picture]
        \draw[fg_sl_color, thick, -stealth] (0.5,-2.05) -- (0.0,-2.05) -- (0.0,2.05) -- (0.5,2.05);
        \node[text width=0.75\textwidth, align=center] at (-1.0,0.0) {If $\mA$ is singular};
