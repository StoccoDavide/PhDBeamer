...
\begin{frame}{Solution of \aclp{DAE}}{\acsp{DAE} are not \acsp{ODE}}
  ...
  \begin{itemize}
    ...
    \item Special \textbf{numerical techniques} are required
    \item \textbf{Reformulation} of the \acs{DAE} system is typically required
  \end{itemize}
  \vspace{1.0em}
  \centering
  ...
  \scriptsize{
    \fullcite{petzold1982differential} \\
    \fullcite{gear1971simultaneous}
  }
\end{frame}
...
\begin{frame}{Solution of \aclp{DAE}}{Index Reduction}
  ...
  \begin{itemize}
    \item<2-> carried out by \textbf{algebraic manipulation} and \textbf{differentiation}
...
\begin{frame}{Solution of \aclp{DAE}}{A New Algorithm for Index Reduction}
  ...
  \uncover<2->{Exploit symbolic computation for \textbf{separating} the differential and algebraic equations in the system!
  \begin{enumerate}
