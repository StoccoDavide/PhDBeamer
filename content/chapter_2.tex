...
\begin{frame}{Solution of \aclp{DAE}}{\acsp{DAE} are not \acsp{ODE}}
  ...
  \begin{itemize}
    \item<1,3-> Special \textbf{numerical techniques} are required
...
\begin{frame}{Solution of \aclp{DAE}}{Differential and Algebraic Equations Separation}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Repeat} until necessary (index-1 \acs{DAE} or \acs{ODE} is reached)
  \end{enumerate}}
  \vspace{0.5em}
...
\begin{frame}{Solution of \aclp{DAE}}{A New Algorithm for Index Reduction}
  ...
  \begin{itemize}
    \item[\raisebox{-1pt}{\scalebox{0.8}{\faQuestion}}] \textbf{None} a priori knowledge of the system structure
  ...
  \end{columns}}
  \vspace{0.5em}
  \uncover<2->{The tools we are going to use are \dots \\
  \begin{itemize}\small
