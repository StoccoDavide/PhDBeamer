...
\begin{frame}{Application Fields and Examples}{Factorizations Performance}
  ...
  \begin{columns}
    ...
    \begin{column}[b]{0.525\textwidth}
      \hic{\ac{LU} performed better than \ac{FFLU}}
    \end{column}
...
\begin{frame}{Application Fields and Examples}{Expression Swell}
  \begin{columns}
    \centering
    \begin{column}[c]{0.675\textwidth}
      \hic{Strong expression swell may still arise \dots}
    \end{column}
    \begin{column}[c]{0.225\textwidth}
...
\begin{frame}{Application Fields and Examples}{Numerical Stability}
  ...
  \end{columns}
  \vspace{-1.5em}
  \input{figures/flexible_slider_crank.tex}
  \input{figures/flexible_slider_crank_pivots.tex}
\end{frame}
...
\begin{frame}{Application Fields and Examples}{Benchmarking the Index Reduction Algorithm}
  ...
  \centering{\small\begin{tabular}{lccccccccccccccc}
    ...
    \midrule
    \rowcolor{mycolor2!25}
    \texttt{dsolve} & \mycheckmark & \mycheckmark & \mycrossmark & \mycheckmark & \mycrossmark & \mycrossmark & \mycrossmark & \mycheckmark & \mycrossmark & \mycrossmark & \mycrossmark & \mycheckmark\mywarnmark & \mycrossmark & \mycrossmark & 28.6 \\
    \rowcolor{mycolor3!25}
