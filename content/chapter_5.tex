...
\begin{frame}{Application Fields and Performance}{Benchmarking the Index Reduction Algorithm}
  ...
  \end{columns}
  \vspace{0.5em}%
  \centering{\setlength{\tabcolsep}{5pt}\small\begin{tabular}{lcccccccccccccc}
    \toprule
    \multirow{3.5}{*}{\textbf{Solver}} & \multicolumn{14}{c}{\textbf{Problems}} \\
    \cmidrule(l{4pt}r{4pt}){2-15}
    & \multicolumn{3}{c}{\acs{MBD}} & \multicolumn{3}{c}{\acs{TPPC}}& \multicolumn{3}{c}{El. Circuits} & \multicolumn{5}{c}{Generic \acsp{DAE}} \\
    \cmidrule(l{4pt}r{4pt}){2-4}\cmidrule(l{4pt}r{4pt}){5-7}\cmidrule(l{4pt}r{4pt}){8-10}\cmidrule(l{4pt}r{4pt}){11-15}
    & \boxednumber{1} & \boxednumber{2} & \boxednumber{3} & \boxednumber{4} & \boxednumber{5} & \boxednumber{6} & \boxednumber{7} & \boxednumber{8} & \boxednumber{9} & \boxednumber{10} & \boxednumber{11} & \boxednumber{12} & \boxednumber{13} & \boxednumber{14} \\
    \midrule
...
\begin{frame}{Application Fields and Performance}{Factorizations Performance}
  ...
  \begin{columns}
    ...
    \begin{column}[b]{0.215\textwidth}
      \vspace{-1.0em}\includegraphics[width=\textwidth]{figures/car_axis.eps}
    \end{column}
  \end{columns}
