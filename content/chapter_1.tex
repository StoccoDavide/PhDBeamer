...
\begin{frame}{Introduction and Motivation}{Dynamic Systems Described by \acsp{ODE} and \acsp{DAE}}
  \begin{itemize}
    \item We consider \textbf{dynamic systems} are described by \dots \\
      \vspace{0.5em}
    ...
    \vspace{0.25em}
    \raggedright
    \item \acsp{ODE} have \textbf{complete} theoretical foundation, \acsp{DAE} do not
